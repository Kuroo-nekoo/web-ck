        ...
        <div class="row">
			...
			<form>
				<div class="form-group form-row">
					...
					<input class="form-control col-md-8" type="text" value="<?php echo $user_data['FULL_NAME']; ?>" readonly/>
				</div>
				<div class="form-group form-row">
					<label for="email" class="col-md-3">Email:</label>
					<input class="form-control col-md-8"type="text" value="<?php echo $user_data['EMAIL']; ?>" readonly/>
				</div>
				<div class="form-group form-row">
